...
const AboutDetails= async ()=>{
    ...
    {dataToUse &&    <div className="py-4 px-6 max-lg:px-4">
    ...
    <div className="flex justify-center items-center  max-lg:flex-col ">
        <div className=" lg:place-content-center lg:w-72 lg:mr-16 max-lg:px-4 max-lg:py-8"><p className="text-white font-semibold  max-lg:pl-4 ">{`${dataToUse.text?dataToUse.text:"lorem ipsum etlodadklasaskj gklsdjlgkds ljkgdsjkldsgl kljkdskjlsfljkgslk jsdgljkdslgjk "}`}</p></div>

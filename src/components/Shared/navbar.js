    ...
    return (
        ...
        <nav className="py-6 lg:px-12 " >
            ...
            <div className="flex justify-between max-lg:px-2 items-center relative">
                ...
                <ul className={`flex justify-center  max-lg:w-full   max-lg:flex-col ${!show ? 'max-lg:hidden' : 'max-lg:block'} max-lg:absolute max-lg:top-[60px] max-lg:left-0 max-lg:bg-[#333] max-lg:p-1 lg:px-[40px] max-lg:z-50`}>                

    ...
    return(
        ...
        <div className="px-4 py-6">
            <div className=" flex max-lg:flex-col justify-between items-center py-8 px-4">
                <div onClick={onOptionHandler.bind(null,"all category")} className="flex flex-col justify-center w-full items-center">
                    <h1 className={`${option=="all category"?"font-bold":""}`}>All category</h1>
                    <div className={`${option=="all category"?"bg-white w-full ease-in duration-300":"bg-gray-500 w-10"}  h-1`}></div>
                </div>
                <div onClick={onOptionHandler.bind(null,"tech")} className="flex flex-col w-full justify-center items-center">
                    <h1 className={`${option=="tech"?"font-bold":""}`}>Tech</h1>
                    <div className={`${option=="tech"?"bg-white w-full ease-in duration-300":"bg-gray-500 w-10"}  h-1`}></div>
                </div>
                <div onClick={onOptionHandler.bind(null,"art")} className="flex flex-col w-full justify-center items-center">
                    <h1 className={`${option=="art"?"font-bold":""}`}>Art</h1>
